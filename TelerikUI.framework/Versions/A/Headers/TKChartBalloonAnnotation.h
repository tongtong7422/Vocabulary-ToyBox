 ...
 */
- (id)initWithText:(NSString*)text X:(id)xValue Y:(id)yValue forSeries:(TKChartSeries*)series;
...
/**
 ...
 @param series The TKChartSeries instance to use with these coordinates.
 */
- (id)initWithText:(NSString *)text point:(id<TKChartData>)point forSeries:(TKChartSeries *)series;
