 ...
 */
typedef enum TKCalendarViewMode
{
    /**
 ...
 */
typedef enum TKCalendarSelectionMode {
 ...
 */
typedef enum TKCalendarCellType {
...
/**
 ...
 @return An array containing instances of TKCalendarEvent class.
 */
- (NSArray*)calendar:(TKCalendar*)calendar eventsForDate:(NSDate*)date;

/**
 *  Asks the data source for an array of TKCalendarEvent events with a callback.
 *
 *  @param calendar       The calendar instance requesting this information.
 ...
 */
- (void)calendar:(TKCalendar*)calendar eventsFromDate:(NSDate*)startDate toDate:(NSDate*)endDate withCallback:(void (^)(NSArray* events))eventsCallback;
 ...
 */
- (void)updateState:(NSDate*)lastSelected;
 ...
 */
@property (nonatomic, strong) TKDateRange* selectedDatesRange;
 ...
 */
+ (NSDate*)dateWithYear:(NSInteger)year month:(NSInteger)month day:(NSInteger)day withCalendar:(NSCalendar*)calendar;
 ...
 */
+ (BOOL)isDate:(NSDate*)date1 equalToDate:(NSDate*)date2 withComponents:(NSCalendarUnit)components withCalendar:(NSCalendar*)calendar;
...
/**
 ...
 @return An array with events if scuccessfull. Nil otherwise.
 */
 ...
 */
- (id<TKCalendarPresenter>)presenter;
