 ...
 */
typedef enum TKChartAnnotationZPosition {
    /**
 ...
 */
- (void)annotationWasAddedToChart:(TKChart*)chart withLayer:(CALayer*)layer;
 ...
 */
- (CGFloat)locationOfValue:(id)value withAxis:(TKChartAxis*)axis inBounds:(CGRect)bounds;
